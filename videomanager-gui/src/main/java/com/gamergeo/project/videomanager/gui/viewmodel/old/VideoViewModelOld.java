...
//
//@Component
//public class VideoViewModelOld {
//	
//	private Video model;
//	
...
//	
//    private final ListProperty<TagViewModelOld> tags = new SimpleListProperty<TagViewModelOld>(FXCollections.observableArrayList());
//    
//    public VideoViewModelOld() {}
//    
//    public VideoViewModelOld(Video video) {
//    	setVideo(video);
...
//    	tags.addListener((ListChangeListener.Change<? extends TagViewModelOld> change) -> {
//    	    while (change.next()) { 
//    	        if (change.wasAdded()) { 
//    	            List<? extends TagViewModelOld> addedSubList = change.getAddedSubList();
//    	            for (TagViewModelOld addedItem : addedSubList) {
//    	            	model.getTags().add(addedItem.getModel());
//    	            }
//    	        }
//    	        if (change.wasRemoved()) {
//    	            List<? extends TagViewModelOld> removedSubList = change.getRemoved();
//    	            for (TagViewModelOld removedItem : removedSubList) {
...
//    	tags.clear();
//    	video.getTags().forEach((tag) -> tags.add(new TagViewModelOld(tag)));
//    	this.model = video;
//    }
//    
...
//	}
//
//    public ObservableList<TagViewModelOld> getTags() {
//        return tags.get();
//    }
//
//    public ListProperty<TagViewModelOld> tagsProperty() {
//        return tags;
//    }
//
