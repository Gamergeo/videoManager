...
//	
//	private VideoViewModelOld selectedVideo;
//	
//	private Video initialVideo;
//	
//	private ListChangeListener<TagViewModelOld> tagListChangeListener = change -> {
...
//	}
//	
//	public void setVideo(VideoViewModelOld video) {
...
//	        		TagViewModelOld tag = new TagViewModelOld(tagService.findById(id));
